...
import { Box, Text, Image, ButtonGroup, Spinner} from "@chakra-ui/react";
        ...
        >
            ...
            <Box width="100%">
                ...
                <Box as="p" fontSize="lg" color="gray.600">
                    10x de <Text as="span" fontSize="xl" fontWeight="bold"> R$ {moneyFormat(Number(preco) / 10)}</Text>
                </Box>
                <Box as="p" color="green.600" fontSize="lg" fontWeight="bold">
                    ou R$ {moneyFormat(precoComDesconto)} à vista
                </Box>
